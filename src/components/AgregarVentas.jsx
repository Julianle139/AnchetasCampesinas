...
class AgregarVentas extends Component{
          ...
          <Form onSubmit={this.addSell}>
              <div className="cont-fatherr">
               ...
               <div className="cont-form">
                  ...
                  <Form.Group className="mb-3 bg-dark text-white" controlId="formBasicPassword" align="center">
  ...
  <div className="break">
            ...
            <div className="search">    
                <div className="icon-search text-white"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                </svg></div>
            <input class="form-control"  placeholder="Busqueda por cliente o ID cliente " value={this.state.text} onChange={(text) => this.filter(text)}  />
            </div>
              ...
              {this.state.ventas.map(venta => {
               return (
                  <tr key={venta._id}>
                    ...
                    <td class="text-dark bg-white">{venta.producto} </td>
